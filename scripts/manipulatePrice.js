...
const sRouter = new web3.eth.Contract(IUniswapV2Router02.abi, config.SUSHISWAP.V2_ROUTER_02_ADDRESS) // QUICKSWAP ROUTER CONTRACT
...
const AMOUNT = '467000000' // 467,000,000 -- Tokens will automatically be converted to wei
const GAS = 450000
